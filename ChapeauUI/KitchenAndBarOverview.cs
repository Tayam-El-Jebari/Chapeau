...
namespace ChapeauUI
{
    public partial class KitchenAndBarOverview : Form
    {
        ...
        private void barListView_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            ListViewItem li = new ListViewItem(barListView.SelectedItems[0].SubItems[0].Text);
            li.SubItems.Add(barListView.SelectedItems[0].SubItems[1].Text);
            li.SubItems.Add(barListView.SelectedItems[0].SubItems[5].Text);
