...
namespace ChapeauDAL
{
    public class OrderDao : BaseDao
    {
        ...
        {
            string query = "SELECT order_id, o.table_Id, o.comments, o.isFinished, o.timePlaced FROM [Order] AS o JOIN [Table] AS t ON t.table_ID = o.table_Id WHERE Waiter_ID IS NULL AND isFinished = 1 AND isDelived IS NULL";
